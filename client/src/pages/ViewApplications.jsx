...
import { viewApplicationsPageData } from '../assets/assests'
import resume_download_icon from '../assets/resume_download_icon.svg'
                            ...
                            <tr key={index} className='text-gray-700'>
                                ...
                                <td className='py-2 px-4 border-b'>
                                    <a href="" target='_blank' className='bg-blue-50 text-blue-400 px-3 py-1 rounded inline-flex gap-2 items-center'>
                                        Resume <img src={resume_download_icon} alt="" />
                                    </a>
                                </td>
